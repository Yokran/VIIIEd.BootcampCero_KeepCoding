...
def nuevo():
    ...
    if request.method == "GET":
        ...
        if formulario.validate():
            ...
            try:
                ...
                return render_template("nuevo_movimient.html", el_formulario=formulario)
    ...
    si la validación es erronea --> devolver el formulario y render_template
        y preparar nuestra plantilñla para gestionar errores
        """
